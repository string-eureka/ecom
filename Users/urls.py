...
urlpatterns = [
    ...
    path('accounts/google/enter/', auth_views.LoginView.as_view(template_name='Users/google_login.html'), name='google-login'),
    path('accounts/google/register/', SignupView.as_view(template_name='Users/google_register.html'), name='google-register'),
